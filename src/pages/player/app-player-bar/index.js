...
export default memo(function AppPlayerBar() {
    ...
    const [isShowBar, setIsShowBar] = useState(false) // 用于是否显示音量播放条
    ...
    const loopBtnStyle = (playSequence) => {
        switch (playSequence) {
            case 1:
                return '-66px -248px'
            case 2:
        ...
        <div className='player-bar-wrapper'>
            <div className='player-content'>
                <div className='player-control'>
                    <button className='player-btn-pre' onClick={e => changeSong(-1)}></button>
                    <button className={isPlaying ? 'player-btn-pause' : 'player-btn-play'} onClick={playMusic}></button>
                    <button className='player-btn-next' onClick={e => changeSong(1)}></button>
                </div>
                ...
                <div className='player-operator'>
                    ...
                    <div className='player-operator-right sprite_player'>
                        <Tooltip title="调节音量">
                            <button className="sprite_player btn volume" onClick={() => setIsShowBar(!isShowBar)}></button>
                        </Tooltip>
                        <Tooltip
                            title={[
                                '顺序播放',
                        ...
                        >
                            <button className="sprite_player btn loop" onClick={(e) => changeSequence()} style={{ backgroundPosition: loopBtnStyle(playSequence) }}></button>
                        </Tooltip>
                        <button
